            ...
            child: Column(
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      menu_card(size,'https://purepng.com/public/uploads/large/purepng.com-food-platefood-meat-plate-tasty-grill-breakfast-dinner-french-fries-launch-941524624215fnp4x.png'),
                      menu_card(size,'https://purepng.com/public/uploads/large/purepng.com-food-platefood-meat-plate-tasty-grill-breakfast-dinner-french-fries-launch-941524624270veqpm.png'),
                      menu_card(size,'https://purepng.com/public/uploads/large/vegetables-btv.png'),
                      menu_card(size,'https://purepng.com/public/uploads/large/purepng.com-amaranth-leavesvegetablesspinach-amaranth-leaves-leafs-941524684589dw2ks.png'),
                    ],
                  ),
                ),
...
Widget resurent_card(final Size size){
  return Card(
...
Widget menu_card(final Size size,String imageUrl){
  return Card(
    shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10)),
    elevation: 2.5,
